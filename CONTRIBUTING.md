...
issue](https://github.com/cisagov/domain-manager-ui/issues) in this
...
request](https://github.com/cisagov/domain-manager-ui/pulls), you will
...
pyenv virtualenv <python_version_to_use> domain-manager-ui
pyenv local domain-manager-ui
