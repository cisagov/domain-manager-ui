...
DR_EXPLAIN.dom = {
  ...
  init: function () {
    ...
    this.tabs.index.$tree =
      this.tabs.index.$wrapperItemInner.children(".b-tree");
    ...
    this.tabs.search.$tree =
      this.tabs.search.$wrapperItemInner.children(".b-tree");
...
DR_EXPLAIN.urlEncoder = (function () {
  var _class = {
    ...
    doBindOpenNextPageWithEncodedStringToLinksInKeywordContextMenu:
      function () {
        var that = this;
  ...
  var _class = {
    ...
    recalculateNavMaxWidth: function () {
      ...
      if (this.dom.$headerSide__nav.length) {
        var headerSide__buttons_width =
          this.dom.$headerSide__buttons.outerWidth();
    ...
    setNewNavWidth: function (newNavWidth) {
      ...
      var longestTreeItemWidthWithPaddings =
        this.visibleTabLongestTreeItemWidth;
