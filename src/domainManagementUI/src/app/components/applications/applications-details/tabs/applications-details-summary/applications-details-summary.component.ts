...
export class ApplicationsDetailsSummaryComponent implements OnInit {
  ...
  setForm(application){
    ...
    this.applicationForm.controls.contactName.setValue(application.contact_name)
    this.applicationForm.controls.contactEmail.setValue(application.contact_email)
    this.applicationForm.controls.contactPhone.setValue(application.contact_phone)
  }
